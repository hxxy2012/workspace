...
//    }, MainActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == FROM_CAPTURE) {
            ...
            } else if (TextUtils.equals(mPosition + "", R.id.id_menu_rbtn_circle + "")) {
                FragmentCircle circle = FragmentCircle.newInstance(unread);
                if (circle != null)
                    circle.onActivityResult(requestCode, resultCode, data);
            }
        }
        if (requestCode == FROM_GALLERY) {
            if (TextUtils.equals(mPosition + "", R.id.id_menu_rbtn_circle + "")) {
                FragmentCircle circle = FragmentCircle.newInstance(unread);
                if (circle != null)
                    circle.onActivityResult(requestCode, resultCode, data);
            }
