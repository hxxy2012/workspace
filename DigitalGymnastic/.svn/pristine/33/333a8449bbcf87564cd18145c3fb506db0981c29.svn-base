...
public class Ruler extends View {
    ...
    private int ITEM_MAX_HEIGHT = 24;
    private int ITEM_MIN_HEIGHT = 16;
    ...
    public Ruler(Context context, AttributeSet attrs) {
        ...
        ITEM_MAX_HEIGHT = dp2px(14);
        ITEM_MIN_HEIGHT = dp2px(10);
        MARGIN_TOP = dp2px(5);
        TEXT_SIZE = sp2px(14);
    ...
    private void drawWheel(Canvas canvas) {
        Drawable wheel = getResources().getDrawable(R.mipmap.ruler_bg);
    ...
    private void drawScaleLine(Canvas canvas) {
        ...
        linePaint.setColor(getResources().getColor(R.color.umeng_socialize_text_share_content));

        TextPaint textPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        textPaint.setColor(getResources().getColor(R.color.umeng_socialize_text_share_content));
        linePaint.setStrokeWidth(dp2px(1));
...
//
                            if ((mValue + i) % mModType == 0 || (mValue + i) % (mModType/2) == 0) {
                                canvas.drawLine(xPosition, getPaddingTop()+MARGIN_TOP, xPosition, getPaddingTop()+MARGIN_TOP+ITEM_MAX_HEIGHT, linePaint);
                    ...
                    if (mValue + i <= mMaxValue) {
                        switch (mModType) {
                         ...
                         canvas.drawLine(xPosition, getPaddingTop()+MARGIN_TOP, xPosition, getPaddingTop()+MARGIN_TOP+ITEM_MIN_HEIGHT, linePaint);
                }
            }
    ...
    private void drawMiddleLine(Canvas canvas) {
        ...
        int gap = 12, indexWidth = dp2px(1), indexTitleWidth = 24, indexTitleHight = 10, shadow = 6;
        ...
        canvas.drawLine(mWidth / 2, MARGIN_TOP, mWidth / 2, MARGIN_TOP + dp2px(20), redPaint);
