...
public class SlideItemWrapLayout extends RelativeLayout {
	...
	public SlideItemWrapLayout(Context context, SlideAction slideLeftAction, SlideAction slideRightAction, View frontView, int leftBackViewId,
			int rightBackViewId) {
		super(context);
		mSlideLeftAction = slideLeftAction;
		mSlideRightAction = slideRightAction;
		init(frontView, leftBackViewId, rightBackViewId);
	}
	...
	//����һ��view��Ϊ��view����󻬶�������ɾ���¼�  --------�������
	private void init(View  frontView, int leftBackViewId, int rightBackViewId) {
		setDescendantFocusability(ViewGroup.FOCUS_BLOCK_DESCENDANTS);
