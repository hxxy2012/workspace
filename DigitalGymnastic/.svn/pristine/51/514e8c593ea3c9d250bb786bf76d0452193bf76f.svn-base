...
public class Constants {
    ...
    public static final Float defaultMaleWeight = (float) 65.0;
    public static final Float defaultSexWeight = (float) 50.0;
    ...
    public static final float defaultStartWeigth = (float) 10.0;
    public static final float defaultEndWeigth = (float) 300.0;
    ...
    public static final int isError = -1;//解析出错标识
    public static final int isSuccess = 0;//响应成功标识
    public static final int isCommandFail = 1;//令牌失效标识
    public static final int isSignError = 2;//令牌失效标识
    public static final int isOtherError = 9999;//其它错误
    ...
    //网络请求
    public static final int getUnreadMessageCount = 0;//获取未读消息数量
    public static final int getMessage = 1;//获取消息
    public static final int queryMessage = 2;//查询消息
    public static final int readMessage = 3;//阅读消息
    public static final int deleteMessage = 4;//删除消息
    public static final int ackPushMessage = 5;//确认推送消息
